...
<Callout variant="info" title="Customizing styles">
  The easiest way to customize Prose UI is by overriding the CSS variables defined in
  `@prose-ui/style/prose-ui.css`. You can inspect the generated CSS and override the variables in your own stylesheet.
</Callout>
