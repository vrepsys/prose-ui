...
pnpm add @prose-ui/core @prose-ui/next @prose-ui/styles @next/mdx @mdx-js/loader @mdx-js/react @types/mdx
```

<Callout variant="info">
Building for a non-Next.js React runtime (Vite, CRA, Remix, etc.)? Install `@prose-ui/react` instead of `@prose-ui/next`, keep `@prose-ui/styles`, and use the same APIs shown below.
</Callout>
